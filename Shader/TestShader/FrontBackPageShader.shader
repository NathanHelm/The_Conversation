Shader "Custom/FrontPageShader"
{
    Properties{
        _FrontSideTex ("Front Side Texture", 2D) = "white" {}
        _FrontSideInsideTex ("Inside-Texture At Center/FrontSide", 2D) = "white" {}
        _BackSideTex ("Back Side Texture", 2D) = "white" {}
        _BackSideInsideTex ("Inside-Texture At Back Side Texture", 2D) = "white" {}
      
        _OffsetBackTex("Back offset xy, z = scale", Vector) = (0, 0, 1, 0)
        _OffsetFrontTex("Front offset xy, z = scale", Vector) = (0, 0, 1, 0)

        _OffsetBack("Inside-Back offset xy, z = scale", Vector) = (0, 0, 1, 0)
        _OffsetFront("Inside-Front offset xy, z = scale", Vector) = (0, 0, 1, 0)
